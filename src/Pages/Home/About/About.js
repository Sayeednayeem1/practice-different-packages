...
const About = () => {
    return (
        <div>
            <section className=" dark:bg-gray-900 mt-10 mb-10">
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7 animate__animated animate__backInLeft">
                        <h1 className="max-w-2xl mb-4 text-2xl text-white font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">This is  <br /> My Portfolio </h1>
                        <p className="max-w-2xl mb-6 font-light text-white dark:text-white lg:mb-8 md:text-lg lg:text-xl ">This is a simple React.js App. I tried to implement new npm packages i didn't Used yet. So far i've used Lottie animation, Flowbite, React slick which i am not familiar with. And It was fun using those new technologies. <br />Besides those technologies i also used tailwind css, row css, React js, react router dom and animate css. </p>
